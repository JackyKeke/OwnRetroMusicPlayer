...
class CalendarUtil {
    ...
    val elapsedToday: Long
        get() = (calendar[Calendar.HOUR_OF_DAY] * 60 + calendar[Calendar.MINUTE]) * MS_PER_MINUTE+
                calendar[Calendar.MINUTE] * MS_PER_MINUTE + calendar[Calendar.SECOND] * 1000 + calendar[Calendar.MILLISECOND]
