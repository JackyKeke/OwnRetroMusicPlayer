...
import com.jackykeke.ownretromusicplayer.helper.StackBlur
import com.jackykeke.ownretromusicplayer.util.ImageUtil
import java.security.MessageDigest

class BlurTransformation constructor(builder: Builder) : BitmapTransformation() {
    ...
    class Builder(val context: Context) {
        ...
        fun build(): BlurTransformation {
            return BlurTransformation(this)
        }
    }
    ...
    override fun transform(
        ...
        try {
            ...
            val input = Allocation.createFromBitmap(rs,out,Allocation.MipmapControl.MIPMAP_NONE,
